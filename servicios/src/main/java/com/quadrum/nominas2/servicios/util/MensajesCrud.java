...
public class MensajesCrud {
    ...
    public static final String ERROR_ALGO = "Ups!...#Ocurrio un problema durante la operaci�n. Intente m�s tarde";
    ...
    public static final String ERROR_HIBERNATE = "Ups!...#Estamos teniendo problemas al conectar con el servidor, intente m�s tarde.";
