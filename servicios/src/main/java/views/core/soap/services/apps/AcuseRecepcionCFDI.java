...
public class AcuseRecepcionCFDI  implements java.io.Serializable {
    ...
    /**
     * Gets the selloSAT value for this AcuseRecepcionCFDI.
     * 
     * @return selloSAT
     */
    ...
    /**
     * Sets the selloSAT value for this AcuseRecepcionCFDI.
     * 
     * @param selloSAT
     */
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("apps.services.soap.core.views", "SelloSAT"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
