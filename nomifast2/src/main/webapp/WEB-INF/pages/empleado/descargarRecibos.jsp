<%-- 
    Document   : descargarRecibos
    Created on : 24/06/2015, 06:46:07 PM
    Author     : vcisneros
--%>
    ...
    <div class="form-inline col-xs-12 col-sm-12 col-lg-9 col-md-9">
        <div class="input-group">
            ...
            <select id="busquedas" class="form-control" aria-describedby="basic-addon1">
                ...
                <option label="Por Empresa" value="5" >Por Sucursal</option>
...
<div class="row">
    <table class="table table-bordered table-condensed table-hover table-striped">
        ...
        <tbody>
            <%@ include file="/WEB-INF/pages/empleado/descargarRecibosBody.jsp"%>
        </tbody>
    </table>
</div>