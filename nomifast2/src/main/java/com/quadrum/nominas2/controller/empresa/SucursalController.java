...
import static com.quadrum.nominas2.servicios.util.Validaciones.esEntero;
...
public class SucursalController {
    ...
    @ResponseBody
    @RequestMapping(value = "compruebaSucursal", method = RequestMethod.POST)
    public boolean compruebaSucursal(@RequestParam("id") String id) {
        if (esEntero(id)) {
            return sucursalServicio.buscarPorId(Integer.parseInt(id)) != null;
        }
        return false;
    }
}
